...
This typical setup, sometimes referred as the \textit{SPDC setup}, is depicted in \reffig{spdc}.
...
First, we pick the key rate ~\refeq{Ho} achieved in an ideal scenario, i.e. in the absence of losses and noises, as the reward to me maximized by the agent. 
